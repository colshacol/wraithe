...
Object.defineProperty(exports, "createEl", {
  enumerable: true,
  get: function get() {
    return _createEl.default;
  }
});
Object.defineProperty(exports, "getAttributes", {
  enumerable: true,
  get: function get() {
    return _getAttributes.default;
  }
});
Object.defineProperty(exports, "getAttributeString", {
  enumerable: true,
  get: function get() {
    return _getAttributeString.default;
  }
});
Object.defineProperty(exports, "getAttributeValueString", {
  enumerable: true,
  get: function get() {
    return _getAttributeValueString.default;
  }
});
Object.defineProperty(exports, "getChildCount", {
  enumerable: true,
  get: function get() {
    return _getChildCount.default;
  }
});
...
Object.defineProperty(exports, "getClassesString", {
  enumerable: true,
  get: function get() {
    return _getClassesString.default;
  }
});
Object.defineProperty(exports, "getClassList", {
  enumerable: true,
  get: function get() {
    return _getClassList.default;
  }
});
Object.defineProperty(exports, "getHtmlValue", {
  enumerable: true,
  get: function get() {
    return _getHtmlValue.default;
  }
});
...
Object.defineProperty(exports, "getSelector", {
  enumerable: true,
  get: function get() {
    return _getSelector.default;
  }
});
Object.defineProperty(exports, "getSelectorString", {
  enumerable: true,
  get: function get() {
    return _getSelectorString.default;
  }
});
Object.defineProperty(exports, "getTextValue", {
  enumerable: true,
  get: function get() {
    return _getTextValue.default;
  }
});
Object.defineProperty(exports, "getTagName", {
  enumerable: true,
  get: function get() {
    return _getTagName.default;
  }
});
Object.defineProperty(exports, "isBestParent", {
  enumerable: true,
  get: function get() {
    return _isBestParent.default;
  }
});
exports.default = void 0;

var _arrayFrom = _interopRequireDefault(__webpack_require__(434));

var _createEl = _interopRequireDefault(__webpack_require__(435));

var _getAttributes = _interopRequireDefault(__webpack_require__(436));

var _getAttributeString = _interopRequireDefault(__webpack_require__(437));

var _getAttributeValueString = _interopRequireDefault(__webpack_require__(438));

var _getChildCount = _interopRequireDefault(__webpack_require__(441));

var _getChildren = _interopRequireDefault(__webpack_require__(442));

var _getClassesString = _interopRequireDefault(__webpack_require__(443));

var _getClassList = _interopRequireDefault(__webpack_require__(444));

var _getHtmlValue = _interopRequireDefault(__webpack_require__(445));

var _getId = _interopRequireDefault(__webpack_require__(446));

var _getParent = _interopRequireDefault(__webpack_require__(447));

var _getSelector = _interopRequireDefault(__webpack_require__(448));

var _getSelectorString = _interopRequireDefault(__webpack_require__(449));

var _getTextValue = _interopRequireDefault(__webpack_require__(450));

var _getTagName = _interopRequireDefault(__webpack_require__(451));

var _isBestParent = _interopRequireDefault(__webpack_require__(452));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _default = function _default(node) {
  var element = (0, _createEl.default)(node);
  var selector = (0, _getSelector.default)({
    node: element
  });
  return selector;
};
...
var _node = _interopRequireDefault(__webpack_require__(29));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

document.addEventListener('click', function (event) {
  chrome.runtime.sendMessage({
    selector: (0, _node.default)(event.target),
    type: 'click'
  });
});
...
var _default = function _default(node) {
  var child = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  var element = {
    node: node,
    id: (0, _.getId)(node),
    specificChild: child,
    tagName: (0, _.getTagName)(node),
    childCount: (0, _.getChildCount)(node),
    children: (0, _.getChildren)(node),
    classList: (0, _.getClassList)(node),
    attributes: (0, _.getAttributes)(node)
  };
  element.parent = (0, _.getParent)(element.node, element);
  return element;
}; // this.node = node;
...
function getAttributes(node) {
  return (0, _.arrayFrom)(node.attributes).reduce(function (final, _ref) {
    var name = _ref.name,
        value = _ref.value;
    final[name] = name === 'class' ? (0, _.getClassList)(node.classList).join(' ') : node.getAttribute(name);
    return final;
  }, {});
}
...
exports.default = getAttributeString;
...
function getAttributeString(_ref) {
  var _ref$base = _ref.base,
      base = _ref$base === void 0 ? '' : _ref$base,
      _ref$attributes = _ref.attributes,
      attributes = _ref$attributes === void 0 ? {} : _ref$attributes;
  return Object.entries(attributes).reduce(function (final, _ref2) {
    var _ref3 = _slicedToArray(_ref2, 2),
        key = _ref3[0],
        value = _ref3[1];

    return key !== 'class' ? "".concat(final, "[").concat(key).concat((0, _.getAttributeValueString)(value), "]") : final;
  }, '');
}
...
exports.default = getAttributeValueString;

var _flowRuntime = _interopRequireDefault(__webpack_require__(439));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function getAttributeValueString(value) {
  var _valueType = _flowRuntime.default.string();

  _flowRuntime.default.param("value", _valueType).assert(value);

  return value.length ? "=\"".concat(value, "\"") : '';
}

_flowRuntime.default.annotate(getAttributeValueString, _flowRuntime.default.function(_flowRuntime.default.param("value", _flowRuntime.default.string())));
...
var _regeneratorRuntime = __webpack_require__(440);
...
function _default(node) {
  ...
  return (_arrayFrom = (0, _.arrayFrom)(node.children)) == null ? void 0 : _arrayFrom.length;
}
...
function getChildren(node) {
  return (0, _.arrayFrom)(node.childNodes).map(function (_node) {
    return _node; // return createEl(_node);
  });
}
...
exports.default = getClassesString;

var _ = __webpack_require__(29);

function getClassesString(node) {
  return (0, _.getClassList)(node.classList).length ? '.' + node.classList.join('.') : '';
}
...
function getClassList(node) {
  return (0, _.arrayFrom)(node.classList);
}
...
exports.default = getHtmlValue;

function getHtmlValue(node) {
...
function getId(node) {
  ...
  return (_node$id = node.id) == null ? void 0 : _node$id.length;
}
...
function getParent(node) {
  if ((0, _.isBestParent)(node)) {
    return null;
  }

  return node.parentNode && (0, _.createEl)(node.parentNode, node);
}
...
function getSelector(_ref) {
  var node = _ref.node,
      _ref$base = _ref.base,
      base = _ref$base === void 0 ? '' : _ref$base;
  var attributes = (0, _.getAttributeString)(node);
  var classes = (0, _.getClassesString)(node);
  var tagName = (0, _.getTagName)(node);
  var selector = (0, _.getSelectorString)({
    tagName: tagName,
    classes: classes,
    attributes: attributes,
    base: base
  });
  return !node.parent ? selector : getSelector({
    base: selector,
    node: node.parent
  });
}
...
exports.default = getSelectorString;

function getSelectorString(_ref) {
  var tagName = _ref.tagName,
      classes = _ref.classes,
      attributes = _ref.attributes,
      base = _ref.base;
  return "".concat(tagName).concat(classes).concat(attributes, " ").concat(base).trim();
}
...
exports.default = isBestParent;

var _ = __webpack_require__(29);

function isBestParent(node) {
  return (0, _.getId)(node) || node.tagName === 'BODY';
}
